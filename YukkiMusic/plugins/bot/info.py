...
from YukkiMusic.utils import code_pannel
from YukkiMusic.utils.database import get_lang, is_commanddelete_on
from YukkiMusic.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from YukkiMusic.utils.inline.botinfo2 import about_back_markup
from YukkiMusic.utils.inline.botinfo2 import code_back_markup
...
async def botinfo_cb(client, CallbackQuery, _):
    ...
    if cb == "info3":
        await CallbackQuery.edit_message_text(
            botinfo.BOT_REPO, reply_markup=keyboard
        )
    elif cb == "info4":
        await CallbackQuery.edit_message_text(
            botinfo.BOT_TUTORIAL, reply_markup=keyboard
        )
